...
public:
	AsdkEdEmployeeReactor(const bool autoInitAndRelease) : AcEditorReactor(), mbAutoInitAndRelease(autoInitAndRelease) {
...
//ACDB_REGISTER_OBJECT_ENTRY_AUTO(AsdkEdEmployeeReactor)